...
func NewInvalidPrevAtxProofV2(
	...
	if atx1.MarriageATX != nil {
		var err error
		equivocationSet1, err = identities.EquivocationSetByMarriageATX(db, *atx1.MarriageATX)
		if err != nil {
	...
	if atx2.MarriageATX != nil {
		var err error
		equivocationSet2, err = identities.EquivocationSetByMarriageATX(db, *atx2.MarriageATX)
		if err != nil {
